      ...
      columns: [
          ...
          items: [
            {
              ...
              desc: 'Sehir yonetim merkezi',
              href: '/civic-intelligence-grid.html',
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              title: 'Health Orchestrator',
              desc: 'Auto-triage sistem',
              href: '/ai-health-orchestrator.html',
            },
          ],
        },
      ],
      ...
      columns: [
        {
          ...
          items: [
            {
              title: 'Finans & Bankacilik',
              desc: 'AI guvenlik & compliance',
        ...
        },
        {
          ...
          items: [
            ...
            {
              title: 'Cagri Merkezi AI',
              desc: 'Sesli yanit sistemleri',
      ...
      columns: [
        {
          ...
          items: [{ title: 'Quantum Computing', desc: 'Kuantum hesaplama', href: '/quantum.html' }],
        },
      ],
    },
    developers: {
          ...
          items: [
            {
              ...
              desc: 'Medical diagnosis & analysis',
              href: '/medical-expert.html',
            },
            {
              title: 'Legal AI',
              desc: 'Legal search & analysis',
              href: '/lydian-legal-search.html',
            },
      ...
      columns: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              title: 'Document AI',
              desc: 'Automatic analysis & summarization',
              href: '/ai-assistant.html',
            },
