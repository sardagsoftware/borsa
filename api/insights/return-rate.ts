/**
 * CIVIC INSIGHTS API - RETURN RATE
 *
 * GET /api/insights/return-rate
 *
 * Purpose: Anonymous return rate statistics for public sector
...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const queryRequest: InsightsQueryRequest = {
      ...
      period_start,
      period_end,
      granularity: 'weekly', // Not used for return_rate, but required by schema
    ...
    console.error('Civic insights error (return_rate):', error);
