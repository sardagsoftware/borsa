    ...
    const response = await axios.post(
        'https://api.groq.com/openai/v1/chat/completions',
        {
            ...
            messages: [
                {
                    role: 'system',
                    content: 'You are LyDian Medical Expert, an AI physician with expertise in quantum chemistry and pharmacology.'
                },
                {
                    role: 'user',
                    content: prompt
    ...
    try {
        ...
        const response = {
            ...
            meta: {
                ...
                disclaimer: 'This analysis is for research purposes only. Not a substitute for professional medical advice.'
            }
        };
