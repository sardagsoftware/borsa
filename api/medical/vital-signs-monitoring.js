  ...
  try {
    ...
    res.json({
      ...
      sepsisRisk: {
        ...
        recommendation:
          news2Score.total >= 5
            ? 'Immediate sepsis workup (lactate, blood cultures)'
            : 'Continue monitoring',
      },
  ...
  return {
    ...
    response:
      totalScore === 0
        ...
        : totalScore <= 4
          ? 'Increase observation frequency, inform nurse'
          : totalScore <= 6
            ? 'Urgent medical review, consider HDU/ICU'
