      ...
      incidents: [
        {
          ...
          type: 'accident',
          title: 'Kaza - E5',
          description: '2 araç çarpıştı',
          severity: 'critical',
          reportedAt: new Date().toISOString(),
        },
        {
          coords: [41.0282, 29.0084],
          type: 'construction',
          title: 'Yol Çalışması',
  ...
  if (path === 'v1/risks') {
    return res.json({
      ...
      risks: [
        ...
        },
        {
          ...
          type: 'flood',
          severity: 3,
          location: { lat: 41.0282, lng: 29.0084 },
          radius: 3000,
          status: 'active',
    ...
    return res.json({
      ...
      markers: [
        {
          coords: [41.0082, 28.9784],
          title: 'Cerrahpaşa Hastanesi',
          description: '450 yatak kapasiteli',
          severity: 'operational',
        },
        {
          coords: [41.0369, 28.985],
          title: 'Taksim İlkyardım',
          description: 'Acil servis aktif',
          severity: 'operational',
        },
      ],
    });
