...
const USA_HOSPITAL_NETWORK = {
  ...
  'cleveland-clinic': {
    ...
    specialties: [
      'Cardiovascular', 'Heart Surgery', 'Neurosurgery', 'Transplant',
      'Cancer Center', 'Digestive Disease', 'Respiratory'
    ],
    integration: {
  ...
  'johns-hopkins': {
    ...
    specialties: [
      'Oncology', 'Neurology', 'Neurosurgery', 'Psychiatry',
      'Rheumatology', 'Geriatrics', 'Ophthalmology'
    ],
    integration: {
  ...
  'mass-general': {
    ...
    specialties: [
      'Emergency Medicine', 'Trauma', 'Cancer Center', 'Neurology',
      'Cardiology', 'Diabetes', 'Infectious Disease'
    ],
    integration: {
  ...
  'ucsf-medical': {
    ...
    specialties: [
      'Neurosurgery', 'Transplant', 'Cancer', 'Diabetes',
      'Pulmonology', 'Cardiology', 'Pediatrics'
    ],
    integration: {
  ...
  'stanford-health': {
    ...
    specialties: [
      'AI-Powered Medicine', 'Precision Health', 'Cancer Innovation',
      'Cardiology', 'Neuroscience', 'Organ Transplant'
    ],
    integration: {
  ...
  'nyu-langone': {
    ...
    specialties: [
      'Orthopedics', 'Rheumatology', 'Neurology', 'Cardiology',
      'Psychiatry', 'Rehabilitation', 'Geriatrics'
    ],
    integration: {
  ...
  'mount-sinai': {
    ...
    specialties: [
      'Geriatrics', 'Cardiology', 'Gastroenterology', 'Nephrology',
      'Pulmonology', 'Neurology', 'Oncology'
    ],
    integration: {
  ...
  'cedars-sinai': {
    ...
    specialties: [
      'Cardiology', 'Cancer', 'Neurosurgery', 'Transplant',
      'Women\'s Health', 'Orthopedics', 'Gastroenterology'
    ],
    integration: {
  ...
  'texas-medical-center': {
    ...
    specialties: [
      'Cancer (MD Anderson)', 'Cardiology (Texas Heart)', 'Pediatrics',
      'Neurology', 'Orthopedics', 'Transplant'
    ],
    integration: {
...
const STATE_HEALTH_SYSTEMS = {
  ...
  'FL': { hospitals: ['Mayo Jacksonville', 'Cleveland Clinic Florida', 'Tampa General'], epicCount: 67 },
