...
const DOCTOR_CREDENTIALS = {
  ...
  'mayo-clinic-doctors': [
    { npi: '1234567890', name: 'Dr. Sarah Chen', specialty: 'Cardiology', hospitalId: 'mayo-clinic' },
    { npi: '1234567891', name: 'Dr. Michael Torres', specialty: 'Neurology', hospitalId: 'mayo-clinic' }
  ],
  'cleveland-clinic-doctors': [
    { npi: '1234567892', name: 'Dr. Emily Rodriguez', specialty: 'Cardiology', hospitalId: 'cleveland-clinic' },
    { npi: '1234567893', name: 'Dr. James Wilson', specialty: 'Oncology', hospitalId: 'cleveland-clinic' }
  ],
  'johns-hopkins-doctors': [
    { npi: '1234567894', name: 'Dr. Jennifer Park', specialty: 'Oncology', hospitalId: 'johns-hopkins' },
    { npi: '1234567895', name: 'Dr. David Kim', specialty: 'Neurosurgery', hospitalId: 'johns-hopkins' }
  ],
  'mass-general-doctors': [
    { npi: '1234567896', name: 'Dr. Lisa Martinez', specialty: 'Emergency Medicine', hospitalId: 'mass-general' },
    { npi: '1234567897', name: 'Dr. Robert Johnson', specialty: 'Trauma Surgery', hospitalId: 'mass-general' }
  ],
  'ucsf-medical-doctors': [
    { npi: '1234567898', name: 'Dr. Amanda Lee', specialty: 'Pulmonology', hospitalId: 'ucsf-medical' },
    { npi: '1234567899', name: 'Dr. Christopher Brown', specialty: 'Neurosurgery', hospitalId: 'ucsf-medical' }
  ]
};
