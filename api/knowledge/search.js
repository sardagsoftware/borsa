  ...
  getActiveSources(domain) {
    const allSources = {
      ...
      pubmed: {
        name: 'PubMed',
        articles: 35000000,
        active: domain === 'medicine' || domain === 'all',
      },
      ...
      ieee: {
        name: 'IEEE',
        articles: 5200000,
        active: domain === 'technology' || domain === 'all',
      },
      springer: {
        name: 'Springer',
        articles: 14000000,
        active: domain === 'science' || domain === 'all',
      },
    };
...
module.exports = async (req, res) => {
  ...
  try {
    const { query, language = 'tr', domain = 'all', page = 1, perPage = 20 } = req.body;
    ...
    // Log analytics
    console.log(
      `✅ Search completed: ${searchResults.totalFound} results in ${searchResults.searchTime}s`
    );
