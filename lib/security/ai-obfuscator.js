...
const AI_MODEL_REGISTRY = {
  ...
  'LEGACY_REASONING_V3': 'AX9F7E2B-3-sonnet-20240229',

  // Alternative Provider Aliases
  'CONVERSATIONAL_AI_ALPHA': 'OX7A3F8D',
  'CONVERSATIONAL_AI_BETA': 'OX5C9E2B',
  'CONVERSATIONAL_AI_GAMMA': 'OX1D4A7F',
  ...
  // Multimodal Aliases
  'VISUAL_INTELLIGENCE_UNIT': 'GE6D8A4F-vision',
  'GENERAL_INTELLIGENCE_CORE': 'GE6D8A4F'
};
...
const PROVIDER_ALIASES = {
  'PRIMARY_AI_PROVIDER': 'lydian-research',
  'SECONDARY_AI_PROVIDER': 'lydian-labs',
  'TERTIARY_AI_PROVIDER': 'perplexity',
  'MULTIMODAL_PROVIDER': 'lydian-vision'
};
...
function validateNoLeaks(obj) {
  const sensitiveTerms = ['AX9F7E2B', 'lydian-research', 'lydian-labs', 'gpt-', 'gemini', 'perplexity'];
...
function sanitizeError(error) {
  ...
  sanitized = sanitized.replace(/AX9F7E2B/gi, 'Language Model');
