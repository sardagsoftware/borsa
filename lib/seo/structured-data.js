...
function generateWebSite(subdomain = 'www') {
  ...
  return {
    ...
    url: baseUrl,
    description: 'Enterprise AI Platform with Multi-Model Intelligence, RAG, Voice & Video AI',
...
function generateSoftwareApplication() {
  return {
    ...
    featureList: [
      'LyDian AI Enterprise Engine',
      'LyDian AI Research Engine',
      'LyDian AI Velocity Engine',
  ...
  return [
    {
      ...
      answer: 'Ailydian, en gelişmiş yapay zeka motorlarını tek bir platformda birleştiren kurumsal yapay zeka çözümüdür. LyDian AI Enterprise, Research ve Velocity motorları ile RAG, ses, video ve kod üretimi gibi gelişmiş özellikler sunar.'
    },
    {
      question: 'Hangi AI modelleri destekleniyor?',
      answer: 'LyDian AI Free, LyDian AI Basic, LyDian AI Pro, LyDian AI Enterprise, LyDian AI Research ve LyDian AI Velocity motorları dahil toplam 15+ farklı AI motoru desteklenmektedir.'
    },
    {
