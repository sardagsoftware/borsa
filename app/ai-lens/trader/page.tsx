...
import { SecurityTicker } from '../../../components/security/SecurityTicker';
      ...
      <div className="bg-binance-panel border-b border-gray-700 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <h1 className="text-xl font-bold text-binance-yellow">⚡ AiLydian Trader</h1>
            <select 
          ...
          {/* Bot Controls & Security */}
          <div className="flex items-center space-x-4">
            {/* Security Ticker */}
            <Link href="/ai-lens/trader/security">
              <SecurityTicker className="hover:bg-gray-700 cursor-pointer transition-colors" />
            </Link>
