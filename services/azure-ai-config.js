...
const warnMissingEnv = (name) => {
  if (!process.env[name] || process.env[name].trim() === '') {
    console.warn(`⚠️ [AzureConfig] ${name} ortam değişkeni tanımlı değil. İlgili Azure özelliği devre dışı kalabilir.`);
  }
};
